...
```typescript
consumer.pause([{ topic: 'my-topic', partition: 0 }, { topic: 'my-topic', partition: 1 }])
consumer.resume([{ topic: 'my-topic', partition: 0 }, { topic: 'my-topic', partition: 1 }])
```
...
// Create topics
await admin.createTopics([
  { name: 'new-topic', numPartitions: 3, replicationFactor: 2 },
])
